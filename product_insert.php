...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/product_insert.css">
						...
						<div class="saller_right_body_wrap">
							...
							<div class="saller_insert_group">
								<div class="product_div">
									...
									<select class="product_select" style="width: 265px;">
										<option>선택하세요</option>
								...
								<div class="more_div" style="display: none;">
									...
									<select class="more_select" style="width: 265px;">
										<option>선택하세요</option><!-- 
							...
							<div class="saller_insert_group">
								...
								<input type="text" class="product_price" placeholder="판매 원가를 입력하세요. ( 숫자만 입력하세요. )" numberOnly="numberOnly">
							</div>
							<div class="saller_insert_group">
								<div class="saller_insert_group_title">
									<p>할인율</p>
								</div>
								<input type="text" class="product_sale" placeholder="할인율을 입력하세요. ( 숫자만 입력하세요. )">
							</div>
							<div class="saller_insert_group">
								<div class="saller_insert_group_title" style="width: 150px; margin-left: -50px;" >
									<p>할인 적용 금액</p>
								</div>
								<input type="text" class="product_sale_success" readonly="readonly" disabled>
							</div>
							<div class="saller_insert_group option_box">
								<div class="option_group_wrap option_group">
									<div class="product_option">
										...
										<select class="product_more_option">
											<option>선택</option>
									...
									<div class="product_more">
										<div class="saller_insert_group_title" style="width: 50px;">
											<p style="width: 50px;">상세 1</p>
										</div>
										<input type="text" class="product_more_insert detail_opt1" placeholder="직접입력" style="width: 90px;">


										<div class="saller_insert_group_title" style="width: 50px; margin-left: 10px;">
											<p style="width: 50px;">상세 2</p>
										</div>
										<input type="text" class="product_more_insert detail_opt2" placeholder="직접입력" style="width: 90px;">
									</div>
									<div class="product_item_count">
										<div class="saller_insert_group_title" style="width: 80px;">
											<p>재고수량</p>
										</div>
										<input type="number" class="product_count_insert">
									</div>
							...
							<div class="saller_insert_group" style="position: relative;">
								...
								<input type="text" class="product_delivery" placeholder="배송 정보를 입력하세요.">
							...
							<div class="saller_insert_group large_group">
								...
								<textarea class="exchange_input" placeholder="교환정보를 입력하세요."></textarea>
							</div>
							<div class="saller_insert_group large_group">
								<div class="saller_insert_group_title">
									<p>환불 정보</p>
								</div>
								<textarea class="refund_input" placeholder="환불정보를 입력하세요."></textarea>
							</div>
							<div class="saller_insert_group large_group">
								<div class="saller_insert_group_title">
									<p>상품 설명</p>
								</div>
								<textarea class="prodcunt_guild_input" placeholder="상품 설명을 입력하세요."></textarea>
							</div>
							<div class="saller_insert_group auto_group">
								...
								<div class="thumbnail_div">
									...
									<input type="file" multiple id="thumbnail-upload_backup"   style="display: none;"/>
								</div>
							</div>
							<div class="saller_insert_group auto_group">
								<div class="saller_insert_group_title">
								...
								<div class="producnt_file_div">
									...
									<input type="file" multiple id="producnt_file-upload_backup"  style="display: none;" //>
								</div>
							</div>
							...
							<div class="producnt_insert_btns"> 
								...
								<button class="producnt_insert_success" style="background-color: #ee1e72;" data-name="<?php echo $row['name'];?>" data-id="<?php echo $_SESSION['user_id']?>">입력완료</button>
							</div>
