...
// alert(p_manage_cate);
	...
	//섬네일 이미지 업로드
	 ...
	 var product_quantity=new Array();
	 		...
	 		$.ajax({
	 				type:"POST",
	 				url:"./php/product_new_insert.php",
	 				data:{thumb:thumb_string, detail:detail_string, p_name:product_name,
	 					...
	 					p_desc:product_desc, p_brand:product_brand},
	 				...
	 				success:function(response){
	 					...
	 					$.ajax({
	 							type:"POST",
	 							url:"./php/option_insert.php",
	 							data:{product_option:product_option, product_detail1:product_detail1,
	 							product_detail2:product_detail2, product_quantity:product_quantity, response:response},
