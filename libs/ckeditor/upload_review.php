...
$uploadfullPath = "C:/xampp/htdocs/becoming0508/libs/ckeditor/review_img/"; 
// 이미지가 웹에서 보여질때 사용되어질 기본 URL입니다. 
// 웹루트 부터의 절대 URL을 입력합니다. 
$imageBaseUrl = "libs/ckeditor/review_img/"; 
...
// 자바스크립트를 사용합니다. 
 // echo "<script type='text/javascript'> console.log(".$funcNum.")</script>"; 
echo "<script type='text/javascript'>; window.parent.CKEDITOR.tools.callFunction(1, '".$url."', ' 파일전송완료')</script>"; 

//  echo '<script type="text/javascript">; {"filename" : "'.$name.'", "uploaded" : 1, "url":"'.$url.'"}
// // </script>'; 
?>
